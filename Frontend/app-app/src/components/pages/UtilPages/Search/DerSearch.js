...
export default function DerSearch() {
  ...
  function submit0(){
     ...
     return (
         <>
         <h1 id="h1">Breakfast</h1>
            <div className='ui_search'>
                <div className='ui_icon_input'>
                    {/* <i class="fa fa-search" aria-hidden="true"></i> */}
                    <i class="fas fa-search"></i>
                    <input type="text" placeholder='Search a Breakfast' className='prompt' onChange={e => setRecipes(e.target.value)} />
